...
import DatatableBookingBusinessOwner from "../../../components/datatable/DatatableBookingBusinessOwner";
import { callRequest } from "../../../utils/requests";
import BusinessLayout from "./../BusinessLayout";
import "./BusinessBookingRequest.css";

const ListBusinessBooking = () => {
    ...
    return (
        <BusinessLayout company={company}>
            <DatatableBookingBusinessOwner />
        </BusinessLayout>
    );
};

export default ListBusinessBooking;
