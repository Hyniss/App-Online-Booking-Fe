...
import HouseownerLayout from "../../pages/houseowner/HouseownerLayout";
import BaseLayout from "../BaseLayout";
// import { AdminLayout } from "../AdminLayout";

export const BookingRequestHistoryHo = () => {
  const user = useAuth();
  ...
  const search = React.useCallback(() => {
    ...
    callRequest("booking-request/house-owner", requestOptions).then(
      (response) => {
          ...
          <table className="h-full w-full table-fixed">
            ...
            <tbody>
              {companyList.map((company) => (
                <CompanyRow data={company} key={company.id} fields={columns} />
              ))}
            </tbody>
          </table>
          {Paging({
